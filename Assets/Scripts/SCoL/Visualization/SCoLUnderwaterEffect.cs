...
namespace SCoL.Visualization
{
    ...
    public class SCoLUnderwaterEffect : MonoBehaviour
    {
        ...
        [Header("Fog Override")]
        public Color underwaterFogColor = new Color(0.11f, 0.24f, 0.34f, 1f);
        public FogMode underwaterFogMode = FogMode.ExponentialSquared;
        [Range(0f, 0.2f)] public float underwaterFogDensity = 0.085f;
        ...
        public Color underwaterBackgroundColor = new Color(0.08f, 0.18f, 0.24f, 1f);
